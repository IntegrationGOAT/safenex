      ...
      <div style={{ maxWidth: '1200px', margin: '0 auto' }}>
        ...
        <div style={{
          ...
          <div className="social-buttons-container">
            ...
            {/* X (Twitter) */}
            <a href="https://twitter.com/safenex" target="_blank" rel="noopener noreferrer" className="social-btn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* Facebook */}
            <a href="https://facebook.com/safenex" target="_blank" rel="noopener noreferrer" className="social-btn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* GitHub */}
            <a href="https://github.com/safenex" target="_blank" rel="noopener noreferrer" className="social-btn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* YouTube */}
            <a href="https://youtube.com/@safenex" target="_blank" rel="noopener noreferrer" className="social-btn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            ...
            {/* Telegram */}
            <a href="https://t.me/safenex" target="_blank" rel="noopener noreferrer" className="social-btn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
